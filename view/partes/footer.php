  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col l4 offset-l2 s12">
        ...
        <a href="https://www.facebook.com/EventosEspecialesSM/" target="_blank"><img src="<?php echo $imagenes;?>patrocinador1.jpg" class="responsive-img circle tooltipped" data-position="bottom" data-delay="50" data-tooltip="Eventos Especiales"  width="30px"></a>
