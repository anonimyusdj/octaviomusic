...
<nav>
    <div class="nav-wrapper <?php echo $color; ?> darken-3">
      ...
      <ul class="right hide-on-med-and-down">
        ...
        <li><a style=" font-size:20px;" href="?c=index&a=musica"><i class="material-icons left">headset</i>Música</a></li>
      ...
      <ul class="side-nav" id="mobile-demo">
        ...
        <li><a style=" font-size:20px; font-weight: bold;" href="?c=index&a=musica"><i class="material-icons left">headset</i>Música</a></li>
