...
<nav>
    <div class="nav-wrapper <?php echo $color; ?> darken-3">
      ...
      <ul class="right hide-on-med-and-down">
        ...
        <li><a style=" font-size:20px;" href="index.php?c=index&a=eventos"><i class="material-icons left">art_track</i>Eventos</a></li>
  ...
  <ul class="side-nav" id="mobile-demo">
        ...
        <li><a style=" font-size:20px; font-weight: bold;" href="index.php?c=index&a=eventos"><i class="material-icons left">art_track</i>Eventos</a></li>
